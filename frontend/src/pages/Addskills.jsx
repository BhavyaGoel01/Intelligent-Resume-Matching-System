...
const styles = {
  ...
  stepTag: {
    display: "inline-block", padding: "3px 12px", background: "#e8f0eb",
    color: "#17352f", borderRadius: 99, fontSize: "0.75rem", fontWeight: 800,
  ...
  card: {
    background: "#ffffff", border: "1px solid #d9c8ad", borderRadius: 16,
    padding: "36px", display: "flex", flexDirection: "column", gap: 24,
    boxShadow: "0 2px 16px rgba(23,53,47,0.08)",
  },
  field: { display: "flex", flexDirection: "column", gap: 8 },
  label: { fontSize: "0.82rem", fontWeight: 600, color: "#40564f", letterSpacing: "0.02em" },
  hint: { fontSize: "0.78rem", color: "#8a9a91" },

  tagInput: {
    display: "flex", flexWrap: "wrap", gap: 8,
    padding: "10px 12px", background: "#fffdf8",
    border: "1px solid #d9c8ad", borderRadius: 8, minHeight: 52, cursor: "text",
  },
  tag: {
    display: "inline-flex", alignItems: "center", gap: 6,
    padding: "4px 10px", background: "#e8f0eb",
    border: "1px solid #a8beb1", borderRadius: 99,
    color: "#17352f", fontSize: "0.82rem", fontWeight: 600,
  },
  tagX: {
    background: "none", border: "none", cursor: "pointer",
    color: "#176b5b", fontSize: "1rem", lineHeight: 1, padding: 0,
    display: "flex", alignItems: "center",
  },
  tagInputBox: {
    border: "none", outline: "none", background: "transparent",
    fontSize: "0.9rem", color: "#17352f", minWidth: 180, flex: 1,
    fontFamily: "'DM Sans', sans-serif",
  },

  countRow: { display: "flex" },
  countBadge: {
    padding: "4px 14px", background: "#e8f0eb", border: "1px solid #a8beb1",
    borderRadius: 99, color: "#176b5b", fontSize: "0.8rem", fontWeight: 600,
  },

  chips: { display: "flex", flexWrap: "wrap", gap: 8 },
  chip: {
    padding: "5px 13px", background: "#fffdf8", border: "1px solid #d9c8ad",
    borderRadius: 99, color: "#40564f", fontSize: "0.8rem", fontWeight: 500,
    cursor: "pointer", fontFamily: "'DM Sans', sans-serif",
    transition: "all 0.15s",
  },

  btn: {
    padding: "13px", background: "#17352f", color: "#fff8ef",
    border: "none", borderRadius: 8, fontFamily: "'Syne', sans-serif",
    fontWeight: 700, fontSize: "0.95rem", cursor: "pointer",
  },
  btnOutline: {
    padding: "13px", background: "transparent", color: "#17352f",
    border: "1px solid #d9c8ad", borderRadius: 8, fontFamily: "'Syne', sans-serif",
  ...
  successCard: {
    ...
    alignItems: "center", gap: 14, boxShadow: "0 2px 16px rgba(23,53,47,0.08)",
  },
  successIcon: { fontSize: "3rem" },
  successTitle: { fontFamily: "'Syne', sans-serif", fontSize: "1.4rem", fontWeight: 700, color: "#17352f" },
  successSub: { color: "#69766f", fontSize: "0.95rem", marginBottom: 4 },
  skillsPreview: { display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center", maxWidth: 500 },
  savedChip: {
    padding: "4px 12px", background: "#e8f0eb", border: "1px solid #a8beb1",
    borderRadius: 99, color: "#17352f", fontSize: "0.8rem", fontWeight: 600,
  },
